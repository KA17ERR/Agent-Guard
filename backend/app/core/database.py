...
Uses SQLite for the prototype. connect_args is only needed for SQLite so
that the same connection isn't required to be used from the same thread
(FastAPI can hand requests to different threads).
"""
import logging
